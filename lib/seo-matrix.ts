...
export const marketServiceMatrix: {
  ...
  markets: [
    ...
    },
    {
      ...
      currency: "USD",
      currencySymbol: "$",
      paymentMethods: ["Crypto", "USDT", "Credit Card", "PayPal", "Wire Transfer"],
      language: "English",
      languageCode: "en",
      timezone: "UTC",
      localKeywords: [
      ...
      regulatoryContext:
        "全球iGaming市场涉及多个国家和地区的法律法规，包括欧盟的GDPR、美国的UIGEA、英国的UKGC等。不同市场对广告投放、支付处理、数据保护都有不同的要求。BR21拥有丰富的多市场运营经验，深度理解各国合规要求，为客户提供全球化的合规解决方案，确保业务在全球范围内合法合规运营。",
      infrastructureChallenge:
        "全球iGaming市场面临的主要技术挑战包括：1. 跨境支付通道不稳定，不同国家的支付方式差异大，需要对接多个支付网关；2. 时区差异导致客服响应慢，需要7x24小时多语言客服支持；3. 汇率波动导致利润损失，需要实时汇率监控和自动结算系统；4. 多语言素材制作成本高，需要本地化团队支持。BR21通过技术整合和本地化运营，为客户提供全球化的技术解决方案。",
      localSlang: [
        "Global",
        "Multi-market",
        "Cross-border",
